 ...
 * fetchDescription() is excluded — tested separately once the network layer is stable.
 *
 * Each test method names the CRN it is testing so failures are easy to trace back
...
public class CourseTest {
    ...
    // "90495","1001","ACC","231","Wilf","Accounting Principles I",3,"Wax; Laurie Faye",0,30,30,0,10,10,"M||W}1500}1615}FURST}F210","SYBC","Sy Syms-UG Business Core"
    private static final String LINE_90495 =
            "\"90495\",\"1001\",\"ACC\",\"231\",\"Wilf\",\"Accounting Principles I\",3,\"Wax; Laurie Faye\",0,30,30,0,10,10,\"M||W}1500}1615}FURST}F210\",\"SYBC\",\"Sy Syms-UG Business Core\"";

    // CRN 90519 — honors course (single attribute HONR)
    // "90519","1001","ACC","241","Wilf","Accounting Principles I",3,"Crawford; Constance J.",0,25,25,0,10,10,"M||W}1630}1745}FURST}F212","HONR","Honors Course"
    private static final String LINE_90519 =
            "\"90519\",\"1001\",\"ACC\",\"241\",\"Wilf\",\"Accounting Principles I\",3,\"Crawford; Constance J.\",0,25,25,0,10,10,\"M||W}1630}1745}FURST}F212\",\"HONR\",\"Honors Course\"";

    // CRN 90465 — Beren campus, alphabetic section
    // "90465","1001","ACC","A","Beren","Accounting Principles I",3,"Hyman; Cody Alyssa",0,30,30,0,5,5,"M||W}0900}1015}LEX215}","SYBC","Sy Syms-UG Business Core"
    private static final String LINE_90465 =
            "\"90465\",\"1001\",\"ACC\",\"A\",\"Beren\",\"Accounting Principles I\",3,\"Hyman; Cody Alyssa\",0,30,30,0,5,5,\"M||W}0900}1015}LEX215}\",\"SYBC\",\"Sy Syms-UG Business Core\"";

    // CRN 90431 — two separate meeting blocks (split by ::)
    // "90431","1002","ACC","D1","Beren","Accounting Principles II",3,"Huang; Henry",0,30,30,0,5,5,"M}1325}1440}LEX215}::W}1325}1440}TBA}","SYBC","Sy Syms-UG Business Core"
    private static final String LINE_90431 =
            "\"90431\",\"1002\",\"ACC\",\"D1\",\"Beren\",\"Accounting Principles II\",3,\"Huang; Henry\",0,30,30,0,5,5,\"M}1325}1440}LEX215}::W}1325}1440}TBA}\",\"SYBC\",\"Sy Syms-UG Business Core\"";

    // CRN 93089 — multiple attributes (HONR||INTC||WRIN) and matching descriptions
    // "93089","1630","ART","621","Wilf","American Architecture",3,"Glassman; Paul",0,15,15,0,5,5,"F}1000}1200}TBA}","HONR||INTC||WRIN","Honors Course||YC-INTC Requirement||YC-WRIN Requirement"
    private static final String LINE_93089 =
            "\"93089\",\"1630\",\"ART\",\"621\",\"Wilf\",\"American Architecture\",3,\"Glassman; Paul\",0,15,15,0,5,5,\"F}1000}1200}TBA}\",\"HONR||INTC||WRIN\",\"Honors Course||YC-INTC Requirement||YC-WRIN Requirement\"";

    // CRN 90483 — empty attributes and descriptions (both "" in the CSV)
    // "90483","1101","ACC","231","Wilf","Intermediate Accounting I",3,"Resnik; Jim",0,30,30,0,10,10,"M||W}1500}1615}FURST}F206","",""
    private static final String LINE_90483 =
            "\"90483\",\"1101\",\"ACC\",\"231\",\"Wilf\",\"Intermediate Accounting I\",3,\"Resnik; Jim\",0,30,30,0,10,10,\"M||W}1500}1615}FURST}F206\",\"\",\"\"";

    // CRN 93326 — two meeting blocks each with two days (M||W in both blocks)
    // "93326","6095","BIBL","ABC","Beren","Peshat and Derash...",2,"Levine; Michelle J.",0,5,5,0,0,0,"M||W}0900}1100}SCW}BEIT MDRSH::M||W}1116}1245}SCW}606","",""
    private static final String LINE_93326 =
            "\"93326\",\"6095\",\"BIBL\",\"ABC\",\"Beren\",\"Peshat and Derash in Medieval Ashkenazic Exegesis\",2,\"Levine; Michelle J.\",0,5,5,0,0,0,\"M||W}0900}1100}SCW}BEIT MDRSH::M||W}1116}1245}SCW}606\",\"\",\"\"";
    ...
    void section_parsedCorrectly_alphanumericSection() {
        ...
        assertEquals("D1", course.getSection());
    }
